...
#define VCNL36866_PROXIMITY_INF_DEFAULT     (85)
#define VCNL36866_PROXIMITY_THDL_DEFAULT    (134)
#define VCNL36866_PROXIMITY_THDH_DEFAULT    (249)
#define VCNL36866_PROXIMITY_AUTOK_MIN       (3)
#define VCNL36866_PROXIMITY_AUTOK_MAX       (250)
#define VCNL36866_LIGHT_CALIBRATION_DEFAULT (1526)
#else
